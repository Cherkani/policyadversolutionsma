  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-50 via-white to-slate-100 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950">
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col gap-6 px-4 py-10 lg:px-0">
        <header className="rounded-3xl border border-white/70 bg-white/95 p-5 shadow-lg backdrop-blur dark:border-slate-800/60 dark:bg-slate-900/80">
          <div className="flex flex-wrap items-center justify-between gap-4">
            <span className="inline-flex items-center rounded-full bg-slate-100 px-4 py-1 text-xs font-semibold uppercase tracking-[0.3em] text-slate-600 dark:bg-slate-800 dark:text-brand">
          ...
          <div className="mt-3 flex flex-wrap items-center justify-between gap-3 text-xs font-semibold text-slate-500 dark:text-slate-200">
        ...
        <div className="rounded-3xl border border-white/60 bg-white/95 shadow-elevated backdrop-blur dark:border-slate-800/70 dark:bg-slate-900/80">
          {currentPage === "policies" ? (
